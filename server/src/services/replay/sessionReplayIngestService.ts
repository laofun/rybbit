...
import { extractHeatmapClicks } from "../heatmap/clickExtractionService.js";
...
export class SessionReplayIngestService {
  async recordEvents(
    ...
    // Implementation lives in services/heatmap/clickExtractionService so
    // this file stays close to upstream; see FORK_PATCHES.md.
    const clicksToInsert = extractHeatmapClicks(
      events,
      siteId,
      sessionId,
